...
CONFIG_PATH="${CONFIG_PATH:-${REPO_ROOT}/configs/methods/layernorm_actor_output_gain_0750_more_epochs_reliability_probe.json}"
...
LOG_ROOT="${LOG_ROOT:-${REPO_ROOT}/artifacts/analysis/rough_terrain_layernorm_actor_more_epochs_reliability_probe/mujoco_parallel_logs}"
...
declare -A RUN_NAMES=(
  [11]="layernorm_actor_output_gain_0750_more_epochs_reliability_probe_rough_terrain_seed11"
  [17]="layernorm_actor_output_gain_0750_more_epochs_reliability_probe_rough_terrain_seed17"
  [23]="layernorm_actor_output_gain_0750_more_epochs_reliability_probe_rough_terrain_seed23"
)

declare -A LOAD_RUNS=(
  [11]="May25_11-28-17_layernorm_actor_output_gain_0750_more_epochs_reliability_probe_rough_terrain_seed11"
  [17]="May25_12-04-08_layernorm_actor_output_gain_0750_more_epochs_reliability_probe_rough_terrain_seed17"
  [23]="May25_12-38-11_layernorm_actor_output_gain_0750_more_epochs_reliability_probe_rough_terrain_seed23"
)
