...
CONFIG_PATH="${CONFIG_PATH:-${REPO_ROOT}/configs/methods/heuristic_smoothing_action_rate_0050_formal_protocol_revision_long_budget.json}"
...
LOG_ROOT="${LOG_ROOT:-${REPO_ROOT}/artifacts/analysis/rough_terrain_formal_protocol_revision_long_budget/mujoco_parallel_logs}"
...
declare -A RUN_NAMES=(
  [11]="heuristic_smoothing_action_rate_0050_formal_protocol_revision_long_budget_rough_terrain_seed11"
  [17]="heuristic_smoothing_action_rate_0050_formal_protocol_revision_long_budget_rough_terrain_seed17"
  [23]="heuristic_smoothing_action_rate_0050_formal_protocol_revision_long_budget_rough_terrain_seed23"
)

declare -A LOAD_RUNS=(
  [11]=".external/humanoid-gym/logs/ecolab_heuristic_smoothing_formal_protocol_revision_long_budget/May21_03-55-49_heuristic_smoothing_action_rate_0050_formal_protocol_revision_long_budget_rough_terrain_seed11"
  [17]=".external/humanoid-gym/logs/ecolab_heuristic_smoothing_formal_protocol_revision_long_budget/May21_04-23-32_heuristic_smoothing_action_rate_0050_formal_protocol_revision_long_budget_rough_terrain_seed17"
  [23]=".external/humanoid-gym/logs/ecolab_heuristic_smoothing_formal_protocol_revision_long_budget/May21_04-51-50_heuristic_smoothing_action_rate_0050_formal_protocol_revision_long_budget_rough_terrain_seed23"
)
...
run_seed() {
  ...
  echo "[seed${seed}] checkpoint=${checkpoint} load_run=${load_run_name} log=${log_path}"
