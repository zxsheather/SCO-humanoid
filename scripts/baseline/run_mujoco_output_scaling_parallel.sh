...
CONFIG_PATH="${CONFIG_PATH:-${REPO_ROOT}/configs/methods/output_scaling_threshold_38_quantile_090_pid_lower_bound_clamp.json}"
...
LOG_ROOT="${LOG_ROOT:-${REPO_ROOT}/artifacts/analysis/rough_terrain_output_scaling_probe/mujoco_parallel_logs}"
...
declare -A RUN_NAMES=(
  [11]="output_scaling_threshold_38_quantile_090_pid_lower_bound_clamp_rough_terrain_seed11"
  [17]="output_scaling_threshold_38_quantile_090_pid_lower_bound_clamp_rough_terrain_seed17"
  [23]="output_scaling_threshold_38_quantile_090_pid_lower_bound_clamp_rough_terrain_seed23"
)

declare -A LOAD_RUNS=(
  [11]="May23_08-02-17_output_scaling_threshold_38_quantile_090_pid_lower_bound_clamp_rough_terrain_seed11"
  [17]="May23_08-24-25_output_scaling_threshold_38_quantile_090_pid_lower_bound_clamp_rough_terrain_seed17"
  [23]="May23_08-48-14_output_scaling_threshold_38_quantile_090_pid_lower_bound_clamp_rough_terrain_seed23"
)
...
echo "=== Output Scaling MuJoCo Replay ==="
